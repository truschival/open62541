...
void Subscription_generateKeepAlive(UA_Subscription *subscription) {
    if(subscription->currentKeepAliveCount <= subscription->maxKeepAliveCount)
        return;
    ...
    subscription->currentKeepAliveCount = 0;
}
